...
export default function Footer() {
  return (
    <footer className="bg-gray-900 dark:bg-gray-950 text-white py-12 section-padding">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="space-y-4">
            ...
            <p className="text-gray-300 leading-relaxed">
              Full-Stack Developer passionate about creating efficient, real-world software solutions.
            </p>
          </div>
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-2">
              ...
              <a href="#experience" className="block text-gray-300 hover:text-primary-400 transition-colors duration-200">
                Experience
              </a>
